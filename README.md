...
```
> curl -XPOST -H "Content-Type: application/json" localhost:9000/SBI.MyServiceEntity/GetValue -d '{"entityId": "foo"}'
...
```shell
> grpcurl -plaintext -d '{"entityId": "foo"}' localhost:9000 SBI.MyServiceEntity/GetValue
ERROR:
  Code: Unknown
